...
import com.wzk.recruit.service.EnterpriseService;
...
public class EnterpriseController {
	...
	public Result hotList(){
		List<Enterprise> enterpriseList =  enterpriseService.findTop9ByIshotOrderByJobcountDesc();
		return new Result(true,StatusCode.OK,"获取热门企业成功",enterpriseList);
	}
